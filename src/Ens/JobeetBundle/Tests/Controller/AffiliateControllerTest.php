...
class AffiliateControllerTest extends WebTestCase
{
    ...
    public function testAffiliateForm()
    {
        ...
        $this->assertEquals('EnsJobeetBundle:Affiliate:new', $client->getRequest()->attributes->get('_controller'));
        ...
        $client->submit($form);
        $this->assertEquals('EnsJobeetBundle:Affiliate:create', $client->getRequest()->attributes->get('_controller'));
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals('EnsJobeetBundle:Affiliate:wait', $client->getRequest()->attributes->get('_controller'));
